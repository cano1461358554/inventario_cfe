<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="RP" class="form-control @error('RP') is-invalid @enderror" value="{{ old('RP', $personal?->RP) }}" id="r_p" placeholder="Rp">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="tipo_usuario" class="form-control @error('tipo_usuario') is-invalid @enderror" value="{{ old('tipo_usuario', $personal?->tipo_usuario) }}" id="tipo_usuario" placeholder="Tipo Usuario">
