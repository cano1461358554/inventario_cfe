                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-cfe text-white">
                            <h4 class="mb-0">{{ __('Bienvenido al Sistema de Inventario CFE') }}</h4>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-info mt-4">
                                <i class="fas fa-info-circle mr-2"></i> {{ __('Has iniciado sesión correctamente. Selecciona una opción del menú para comenzar.') }}
                            </div>
                        </div>
                    </div>
                </div>
