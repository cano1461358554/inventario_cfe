        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('almacens.index') }}" class="mb-4">
                    <div class="row">
                        <div class="col-md-5">
                            <input type="text" name="nombre" class="form-control" placeholder="Buscar almacén..." value="{{ request('nombre') }}">
                        </div>
                        <div class="col-md-3">
                    ...
                    <table class="table table-bordered">
                        ...
                        @forelse ($almacens as $almacen)
                            ...
                            <tr class="{{ $coincide ? 'table-success' : '' }}">
                                ...
                                <td>{{ $almacen->ubicacion->ubicacion }}</td>
                                <td class="text-center">
{{--                                    <a href="{{ route('almacens.show', $almacen->id) }}" class="btn btn-primary btn-sm">--}}
{{--                                        <i class="fa fa-eye"></i> Ver--}}
{{--                                    </a>--}}
                                    <a href="{{ route('almacens.edit', $almacen->id) }}" class="btn btn-warning btn-sm">
