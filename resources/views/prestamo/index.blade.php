                ...
                <form method="GET" action="{{ route('prestamos.index') }}" class="mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-4 text-end">
                            <a href="{{ route('prestamos.create') }}" class="btn btn-custom-light-green text-white">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        @forelse ($prestamos as $prestamo)
                            ...
                            <tr class="{{ $completamenteDevuelto ? 'table-success' : '' }}">
                                ...
                                <td>{{ $prestamo->material->nombre ?? 'Sin material' }}</td>
                                <td>{{ $prestamo->personal->nombre ?? 'Sin personal' }} {{ $prestamo->personal->apellido ?? '' }}</td>
                                ...
                                <td class="text-center">
                                    ...
                                    @if(!$completamenteDevuelto)
                                        <button class="btn btn-info btn-sm" data-toggle="modal"
                                                ...
                                                data-personal="{{ $prestamo->personal->nombre ?? 'Sin personal' }} {{ $prestamo->personal->apellido ?? '' }}"
