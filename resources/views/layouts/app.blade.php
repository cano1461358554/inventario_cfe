        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav mr-auto">
                    <!-- Menú Movimientos -->
                    @if(!$isEmpleado || request()->is('prestamos*'))
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle {{ request()->is('prestamos*') || request()->is('ingresos*') ? 'active-menu-item' : '' }}"
...
{{--                                       href="{{ route('resguardos.index') }}">Resguardos</a>--}}
                    ...
                    @else
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('prestamos*') ? 'active-menu-item' : '' }}"
                    ...
                    <!-- Menú Materiales -->
                    @if(!$isEmpleado || request()->is('materials*'))
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle {{ request()->is('almacens*') || request()->is('materials*') || request()->is('stocks*') ? 'active-menu-item' : '' }}"
                    ...
                    @else
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('materials*') ? 'active-menu-item' : '' }}"
                    ...
                    @if(!$isEmpleado)
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle {{ request()->is('personals*') ? 'active-menu-item' : '' }}"
                               href="#" id="adminDropdown" data-toggle="dropdown">
                                <i class="fas fa-users-cog"></i> Administración
                            </a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item {{ request()->is('personals*') ? 'active' : '' }}"
                                   href="{{ route('personals.index') }}">Usuarios</a>
                            </div>
                        </li>
                    @endif
                </ul>
