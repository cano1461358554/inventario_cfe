    ...
    <div class="container">
        <div class="card shadow-lg">
            <div class="card-header text-center text-white" style="background-color: #00723E;">
                <h3 class="mb-0"><i class="fa fa-tags"></i> <?php echo e(__('Gestión de Categorías')); ?></h3>
            </div>
            ...
            <div class="card-body">
                ...
                <form method="GET" action="<?php echo e(route('categorias.index')); ?>" class="mb-4">
                    <div class="row">
                        <div class="col-md-5">
                            <input type="text" name="nombre" class="form-control" placeholder="Buscar categoría..." value="<?php echo e(request('nombre')); ?>">
                        </div>
                        <div class="col-md-3">
                            <button type="submit" class="btn text-white" style="background-color: #4CAF50;">
                                <i class="fa fa-search"></i> Buscar
                            </button>
                            <a href="<?php echo e(route('categorias.index')); ?>" class="btn btn-warning">
                                <i class="fa fa-sync-alt"></i> Limpiar
                            </a>
                        </div>
                        <div class="col-md-4 text-end">
                            <a href="<?php echo e(route('categorias.create')); ?>" class="btn text-white" style="background-color: #A4D65E;">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr class="<?php echo e($coincide ? 'table-success' : ''); ?>">
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="<?php echo e(route('categorias.edit', $categoria->id)); ?>" class="btn btn-warning btn-sm">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cfe\resources\views/categoria/index.blade.php ENDPATH**/ ?>